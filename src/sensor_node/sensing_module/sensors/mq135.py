...
class MQ135(MQSensor):
    def __init__(self):
        ...
        self._MIN_CONCENTRATION = env.float("MQ135_MIN_CONCENTRATION", default=None)
        self._MAX_CONCENTRATION = env.float("MQ135_MAX_CONCENTRATION", default=None)
        self._MIN_HUMIDITY = env.float("MQ135_MIN_HUMIDITY", default=None)
        self._MAX_HUMIDITY = env.float("MQ135_MAX_HUMIDITY", default=None)
        self._MIN_TEMPERATURE = env.float("MQ135_MIN_TEMPERATURE", default=None)
        self._MAX_TEMPERATURE = env.float("MQ135_MAX_TEMPERATURE", default=None)

        super().__init__(
            NAME=self._NAME,
            R1=self._R1,
            R2=self._R2,
            MQ_ADC_PIN=self._MQ_ADC_PIN,
            RL_VALUE=self._RL_VALUE,
            RO_CLEAN_AIR=self._RO_CLEAN_AIR,
            A_EXPO=self._A_EXPO,
            M_EXPO=self._M_EXPO,
            RSRO_CLEAN_AIR=self._RSRO_CLEAN_AIR,
            MIN_CONCENTRATION=self._MIN_CONCENTRATION,
